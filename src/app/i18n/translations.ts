...
export const dict: Dict = {
  ...
  'apps.installed_toast':     { en: 'App installed for your company', km: 'បានដំឡើងសម្រាប់ក្រុមហ៊ុន', zh: '已为公司安装' },
  'apps.uninstalled_toast':   { en: 'App uninstalled for your company', km: 'បានដកចេញសម្រាប់ក្រុមហ៊ុន', zh: '已为公司卸载' },
  ...
  'nav.reports.sale_ledger':  { en: 'Sale Ledger',          km: 'សៀវភៅបញ្ជីលក់',    zh: '销售台账' },
  'nav.reports.purchase_ledger': { en: 'Purchase Ledger',  km: 'សៀវភៅបញ្ជីទិញ',    zh: '采购台账' },
  'nav.reports.profit_loss':  { en: 'Profit & Loss',        km: 'ប្រាក់ចំណេញ និងខាត',  zh: '损益表' },
