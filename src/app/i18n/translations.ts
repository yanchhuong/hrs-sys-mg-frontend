...
export const dict: Dict = {
  ...
  'page.exception.title':        { en: 'All Leave',                   km: 'ច្បាប់ឈប់សម្រាកទាំងអស់', zh: '全部请假' },
  'page.exception.description':  { en: 'Leave requests routed to each employee\'s direct leader for approval', km: 'សំណើច្បាប់ត្រូវបានបញ្ជូនទៅមេដឹកនាំផ្ទាល់នៃបុគ្គលិកដើម្បីអនុម័ត', zh: '请假申请由员工的直属领导审批' },
