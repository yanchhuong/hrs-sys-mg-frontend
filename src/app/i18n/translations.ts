...
export const dict: Dict = {
  ...
  'nav.quotations':           { en: 'Quotation',            km: 'សម្រង់តម្លៃ',         zh: '报价单' },
  'nav.invoices':             { en: 'Invoice',              km: 'វិក្កយបត្រ',           zh: '发票' },
  'nav.pos':                  { en: 'POS',                  km: 'POS',                  zh: 'POS' },
  ...
  'nav.consignment':          { en: 'Consignment',          km: 'បញ្ញើលក់',             zh: '寄售' },
  'nav.settlement':           { en: 'Settlement',           km: 'ការទូរទាត់',           zh: '结算' },
  ...
  'nav.taxDeclarations':      { en: 'Tax Declarations',     km: 'របាយការណ៍ពន្ធដារ',       zh: '税务申报' },
