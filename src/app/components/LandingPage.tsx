...
/* ModulesGrid was extracted 2026-08-13 to ./landing/ModulesGrid.tsx + ./landing/moduleCategories.ts.
   Adding a new category = push into LANDING_CATEGORIES in moduleCategories.ts; no JSX touched. */
